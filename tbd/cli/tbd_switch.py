...
def main(args, repo):
  ...
  if not b:
    ...
    pprint.err_exp('to list existing branches do tbd branch')
    pprint.err_exp('to create a new branch do tbd branch -c {0}'.format(args.branch))
    return False
